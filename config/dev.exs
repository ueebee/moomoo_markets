...
config :moomoo_markets, MoomooMarketsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xYWwaLgx2TR392bekcZjHSDLhqjHDqG0JptfwLRQ4QmVAX3itjqNJrFXdHMC6ncR",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:moomoo_markets, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:moomoo_markets, ~w(--watch)]}
  ]
...
config :moomoo_markets, MoomooMarketsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/moomoo_markets_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :moomoo_markets, dev_routes: true
